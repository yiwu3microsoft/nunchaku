...
# Convert to bfloat16 to match pipeline dtype
# model_qwen_vl = model_qwen_vl.to(torch.bfloat16)
...
pipe = QwenImagePipeline.from_pretrained(
    "Qwen/Qwen-Image", text_encoder=model_qwen_vl, transformer=transformer, scheduler=scheduler, torch_dtype=torch.float16
)
